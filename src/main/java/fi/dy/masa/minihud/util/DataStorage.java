...
//                else if (this.clientStructureGeneration)
    ...
    private void updateStructureDataFromClientGeneration(BlockPos playerPos) {
        if (this.worldSeedValid && this.mc.world != null) {
                ...
                for (int rz = minRZ; rz <= maxRZ; ++rz) {
                    for (int rx = minRX; rx <= maxRX; ++rx) {
                        for (StructureType type : enabledTypes) {
                            ...
                            StructureData structureData = ClientStructureGeneration.getStructurePos(this.mc.world,
                                                                                                    type,
                                                                                                    rx,
                                                                                                    rz,
                            ...
                            if (structureData != null) {
                                this.structures.put(type, structureData);
                            }
                        }
                    }
                }
